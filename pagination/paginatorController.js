...
app.run(function(paginationConfig){
    paginationConfig.firstText='Inizio';
    paginationConfig.previousText='Precedente';
    paginationConfig.nextText='Successivo';
    paginationConfig.lastText='Fine';

});

var paginatorController = function ($scope) {
